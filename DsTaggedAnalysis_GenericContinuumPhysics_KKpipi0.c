...
double dsPlusMCut_center=1.96849, dsPlusMCut_range=0.015;
...
double pi0MassCut_center=0.135, pi0MassCut_range=0.010;
...
int DsTaggedAnalysis_GenericContinuumPhysics_KKpipi0()
{
  ...
  std::cout<<"Number of generic events after KKpipi0 tag = "<<genericEvents.tagCut<<std::endl;
  ...
  std::cout<<"Number of continu events after KKpipi0 tag = "<<continuEvents.tagCut<<std::endl;
  ...
  std::cout<<"Number of physics events after KKpipi0 tag = "<<physicsEvents.tagCut<<std::endl;
  ...
  std::cout<<"Number of physics events after pi0MassCut = "<<physicsEvents.pi0MassCut<<std::endl;
  ...
  line = new TLine(xmin,ymax,xmin,0); line->Draw();
  line = new TLine(xmax,ymax,xmax,0); line->Draw();
  gPad->Print("mBC_generic_KKpipi0.png");
  MBC->cd(2);
  h_MBC_continu->Draw();
  ymax=(h_MBC_continu->GetMaximum())*0.75;
  line = new TLine(xmin,ymax,xmin,0); line->Draw();
  line = new TLine(xmax,ymax,xmax,0); line->Draw();
  gPad->Print("mBC_continu_KKpipi0.png");
  MBC->cd(3);
  h_MBC_physics->Draw();
  ymax=(h_MBC_physics->GetMaximum())*0.75;
  line = new TLine(xmin,ymax,xmin,0); line->Draw();
  line = new TLine(xmax,ymax,xmax,0); line->Draw();
  gPad->Print("mBC_physics_KKpipi0.png");
  ...
  gPad->Print("dPhi_generic_KKpipi0.png");
  dPhi->cd(2);  
  h_dPhi_continu->Draw();
  ymax=(h_dPhi_continu->GetMaximum())*0.75;
  line = new TLine(dPhiCutLess,ymax,dPhiCutLess,0); line->Draw();
  gPad->Print("dPhi_continu_KKpipi0.png");
  dPhi->cd(3);
  h_dPhi_physics->Draw();
  ymax=(h_dPhi_physics->GetMaximum())*0.75;
  line = new TLine(dPhiCutLess,ymax,dPhiCutLess,0); line->Draw();
  gPad->Print("dPhi_physics_KKpipi0.png");
  ...
  pi0->cd(3);
  h_pi0_physics->Draw();
  ymax=(h_pi0_physics->GetMaximum())*0.75;
  line = new TLine(xmin, ymax, xmin, 0); line->Draw();
  line = new TLine(xmax, ymax, xmax, 0); line->Draw();
