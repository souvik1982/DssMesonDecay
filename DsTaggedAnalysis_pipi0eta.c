...
double dsPlusMCut_center=1.96849, dsPlusMCut_range=0.036;
double deltaECut_range=0.047;
...
int DsTaggedAnalysis_pipi0eta()
{

  TFile *signalFile = new TFile("MyDChainFile_MC_vtosll_pipi0eta.root");
  ...
  TFile *converFile = new TFile("MyDChainFile_MCgamma_pipi0eta.root");
  ...
  std::cout<<"Number of signal events after pipi0eta tag = "<<signalEvents.tagCut<<std::endl;
  ...
  std::cout<<"Number of conver events after pipi0eta tag = "<<converEvents.tagCut<<std::endl;
  ...
  std::cout<<"Number of physic events after pipi0eta tag = "<<physicEvents.tagCut<<std::endl;
  ...
  line = new TLine(xmax, ymin, xmin, ymin); line->Draw();
  line = new TLine(xmin, ymin, xmin, ymax); line->Draw();
  gPad->Print("mBC_signal_pipi0eta.png");
  MBC_DeltaM->cd(2);
  ...
  line = new TLine(xmax, ymin, xmin, ymin); line->Draw();
  line = new TLine(xmin, ymin, xmin, ymax); line->Draw();
  gPad->Print("mBC_conver_pipi0eta.png");
  MBC_DeltaM->cd(3);
  ...
  line = new TLine(xmax, ymin, xmin, ymin); line->Draw();
  line = new TLine(xmin, ymin, xmin, ymax); line->Draw();
  gPad->Print("mBC_physic_pipi0eta.png");
  ...
  line = new TLine(xmax, ymin, xmin, ymin); line->Draw();
  line = new TLine(xmin, ymin, xmin, ymax); line->Draw();
  gPad->Print("dPhi_diffD0_signal_pipi0eta.png");
  dPhi_diffD0->cd(2);
  ...
  line = new TLine(xmax, ymin, xmin, ymin); line->Draw();
  line = new TLine(xmin, ymin, xmin, ymax); line->Draw();
  gPad->Print("dPhi_diffD0_conver_pipi0eta.png");
  dPhi_diffD0->cd(3);
  ...
  line = new TLine(xmax, ymin, xmin, ymin); line->Draw();
  line = new TLine(xmin, ymin, xmin, ymax); line->Draw();
  gPad->Print("dPhi_diffD0_physic_pipi0eta.png");
