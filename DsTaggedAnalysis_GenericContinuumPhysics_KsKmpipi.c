...
int DsTaggedAnalysis_GenericContinuumPhysics_KsKmpipi()
{
  ...
  std::cout<<"Number of generic events after KsKmpipi tag = "<<genericEvents.tagCut<<std::endl;
  ...
  std::cout<<"Number of continu events after KsKmpipi tag = "<<continuEvents.tagCut<<std::endl;
  ...
  std::cout<<"Number of physics events after KsKmpipi tag = "<<physicsEvents.tagCut<<std::endl;
  ...
  line = new TLine(xmin,ymax,xmin,0); line->Draw();
  line = new TLine(xmax,ymax,xmax,0); line->Draw();
  gPad->Print("mBC_generic_KsKmpipi.png");
  MBC->cd(2);
  h_MBC_continu->Draw();
  ymax=(h_MBC_continu->GetMaximum())*0.75;
  line = new TLine(xmin,ymax,xmin,0); line->Draw();
  line = new TLine(xmax,ymax,xmax,0); line->Draw();
  gPad->Print("mBC_continu_KsKmpipi.png");
  MBC->cd(3);
  h_MBC_physics->Draw();
  ymax=(h_MBC_physics->GetMaximum())*0.75;
  line = new TLine(xmin,ymax,xmin,0); line->Draw();
  line = new TLine(xmax,ymax,xmax,0); line->Draw();
  gPad->Print("mBC_physics_KsKmpipi.png");
  ...
  gPad->Print("dPhi_generic_KsKmpipi.png");
  dPhi->cd(2);  
  h_dPhi_continu->Draw();
  ymax=(h_dPhi_continu->GetMaximum())*0.75;
  line = new TLine(dPhiCutLess,ymax,dPhiCutLess,0); line->Draw();
  gPad->Print("dPhi_continu_KsKmpipi.png");
  dPhi->cd(3);
  h_dPhi_physics->Draw();
  ymax=(h_dPhi_physics->GetMaximum())*0.75;
  line = new TLine(dPhiCutLess,ymax,dPhiCutLess,0); line->Draw();
  gPad->Print("dPhi_physics_KsKmpipi.png");
