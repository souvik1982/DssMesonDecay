...
int DsTaggedAnalysis_GenericContinuumPhysics_pietaprimerho()
{
  ...
  std::cout<<"Number of generic events after pietaprimerho tag = "<<genericEvents.tagCut<<std::endl;
  ...
  std::cout<<"Number of continu events after pietaprimerho tag = "<<continuEvents.tagCut<<std::endl;
  ...
  std::cout<<"Number of physics events after pietaprimerho tag = "<<physicsEvents.tagCut<<std::endl;
  ...
  gPad->Print("dsPlusM_generic_pietaprimerho.png"); 
  dsPlusM->cd(2);
  h_dsPlusM_continu->Draw();
  ymax=(h_dsPlusM_continu->GetMaximum())*0.75;
  line = new TLine(xmin,ymax,xmin,0); line->Draw();
  line = new TLine(xmax,ymax,xmax,0); line->Draw();
  gPad->Print("dsPlusM_continu_pietaprimerho.png");
  dsPlusM->cd(3);
  h_dsPlusM_physics->Draw();
  ymax=(h_dsPlusM_physics->GetMaximum())*0.75;
  line = new TLine(xmin,ymax,xmin,0); line->Draw();
  line = new TLine(xmax,ymax,xmax,0); line->Draw();
  gPad->Print("dsPlusM_physics_pietaprimerho.png");
  ...
  line = new TLine(xmax, ymin, xmin, ymin); line->Draw();
  line = new TLine(xmin, ymin, xmin, ymax); line->Draw();
  gPad->Print("mBC_DeltaM_generic_pietaprimerho.png");
  MBC_DeltaM->cd(2);
  ...
  line = new TLine(xmax, ymin, xmin, ymin); line->Draw();
  line = new TLine(xmin, ymin, xmin, ymax); line->Draw();
  gPad->Print("mBC_DeltaM_continu_pietaprimerho.png");
  MBC_DeltaM->cd(3);
  ...
  line = new TLine(xmax, ymin, xmin, ymin); line->Draw();
  line = new TLine(xmin, ymin, xmin, ymax); line->Draw();
  gPad->Print("mBC_DeltaM_physics_pietaprimerho.png");
  ...
  */
  ...
  line = new TLine(xmin,ymax,xmin,0); line->Draw();
  line = new TLine(xmax,ymax,xmax,0); line->Draw();
  gPad->Print("DeltaE_generic_pietaprimerho.png");
  DeltaE->cd(2);
  h_DeltaE_continu->Draw();
  ymax=(h_DeltaE_continu->GetMaximum())*0.75;
  line = new TLine(xmin,ymax,xmin,0); line->Draw();
  line = new TLine(xmax,ymax,xmax,0); line->Draw();
  gPad->Print("DeltaE_continu_pietaprimerho.png");
  DeltaE->cd(3);
  h_DeltaE_physics->Draw();
  ymax=(h_DeltaE_physics->GetMaximum())*0.75;
  line = new TLine(xmin,ymax,xmin,0); line->Draw();
  line = new TLine(xmax,ymax,xmax,0); line->Draw();
  gPad->Print("DeltaE_physics_pietaprimerho.png");
  ...
  line = new TLine(xmin,ymax,xmin,0); line->Draw();
  line = new TLine(xmax,ymax,xmax,0); line->Draw();
  gPad->Print("mBC_generic_pietaprimerho.png");
  MBC->cd(2);
  h_MBC_continu->Draw();
  ymax=(h_MBC_continu->GetMaximum())*0.75;
  line = new TLine(xmin,ymax,xmin,0); line->Draw();
  line = new TLine(xmax,ymax,xmax,0); line->Draw();
  gPad->Print("mBC_continu_pietaprimerho.png");
  MBC->cd(3);
  h_MBC_physics->Draw();
  ymax=(h_MBC_physics->GetMaximum())*0.75;
  line = new TLine(xmin,ymax,xmin,0); line->Draw();
  line = new TLine(xmax,ymax,xmax,0); line->Draw();
  gPad->Print("mBC_physics_pietaprimerho.png");
  ...
  line = new TLine(xmin,ymax,xmin,0); line->Draw();
  line = new TLine(xmax,ymax,xmax,0); line->Draw();
  gPad->Print("DeltaM_generic_pietaprimerho.png");
  DeltaM->cd(2);
  h_DeltaM_continu->Draw();
  ymax=(h_DeltaM_continu->GetMaximum())*0.75;
  line = new TLine(xmin,ymax,xmin,0); line->Draw();
  line = new TLine(xmax,ymax,xmax,0); line->Draw();
  gPad->Print("DeltaM_continu_pietaprimerho.png");
  DeltaM->cd(3);
  h_DeltaM_physics->Draw();
  ymax=(h_DeltaM_physics->GetMaximum())*0.75;
  line = new TLine(xmin,ymax,xmin,0); line->Draw();
  line = new TLine(xmax,ymax,xmax,0); line->Draw();
  gPad->Print("DeltaM_physics_pietaprimerho.png");
  ...
  gPad->Print("dPhi_generic_pietaprimerho.png");
  dPhi->cd(2);  
  h_dPhi_continu->Draw();
  ymax=(h_dPhi_continu->GetMaximum())*0.75;
  line = new TLine(dPhiCutLess,ymax,dPhiCutLess,0); line->Draw();
  gPad->Print("dPhi_continu_pietaprimerho.png");
  dPhi->cd(3);
  h_dPhi_physics->Draw();
  ymax=(h_dPhi_physics->GetMaximum())*0.75;
  line = new TLine(dPhiCutLess,ymax,dPhiCutLess,0); line->Draw();
  gPad->Print("dPhi_physics_pietaprimerho.png");
