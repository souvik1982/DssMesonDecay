...
Double_t converFit(Double_t *x, Double_t *par) // 11 Parameters
{
  Double_t result;
...
void DsGammaAnalysis_MBC_Fitter_works()
{
  ...
  */
  ...
  h_MBC_conver->Draw();
  TF1 *f_converFit=new TF1("f_converFit", converFit, conver_xmin, conver_xmax, 11);
  ...
  TF1 *f_dataFit=new TF1("f_dataFit", dataFit, data_xmin, data_xmax, 26);
  ...
  f_dataFit->SetParLimits(19, 2.110, 2.113);
  ...
  //s_MBC_Background->Add(h_MBC_generic_right, "hist");
  ...
  TF1 *f_genericFit=new TF1("f_genericFit", dataFit, generic_xmin, generic_xmax, 26);
