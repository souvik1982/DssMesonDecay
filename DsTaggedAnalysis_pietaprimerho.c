...
int DsTaggedAnalysis_pietaprimerho()
{

  TFile *signalFile = new TFile("MyDChainFile_MC_vtosll_pietaprimerho.root");
  signalFile->cd("DsTaggedDecaysProc");
  TTree *signalTree = (TTree*)gDirectory->Get("nt5");
  
  TFile *converFile = new TFile("MyDChainFile_MCgamma_pietaprimerho.root");
  ...
  TH1D *h_dPhi_signal = new TH1D("h_dPhi_signal", "dPhi", 50, -pi, pi); h_dPhi_signal->SetLineColor(kRed);
  TH1D *h_dPhi_conver = new TH1D("h_dPhi_conver", "dPhi", 50, -pi, pi); h_dPhi_conver->SetLineColor(kBlue);
  TH1D *h_dPhi_physic = new TH1D("h_dPhi_physic", "dPhi", 50, -pi, pi); h_dPhi_physic->SetLineColor(kGreen);
  TH2D *h_dPhi_ee_signal = new TH2D("h_dPhi_ee_signal", "dPhi_ee_signal", 50, 0., 0.2, 50, -pi, pi);
  TH2D *h_dPhi_ee_conver = new TH2D("h_dPhi_ee_conver", "dPhi_ee_conver", 50, 0., 0.2, 50, -pi, pi);
  TH2D *h_dPhi_ee_physic = new TH2D("h_dPhi_ee_physic", "dPhi_ee_physic", 50, 0., 0.2, 50, -pi, pi);
  ...
  TH2D *h_dPhi_sumPhi_signal = new TH2D("h_dPhi_sumPhi_signal", "dPhi_sumPhi_signal", 50, -2*pi, 2*pi, 50, -pi, pi);
  TH2D *h_dPhi_sumPhi_conver = new TH2D("h_dPhi_sumPhi_conver", "dPhi_sumPhi_conver", 50, -2*pi, 2*pi, 50, -pi, pi);
  TH2D *h_dPhi_sumPhi_physic = new TH2D("h_dPhi_sumPhi_physic", "dPhi_sumPhi_physic", 50, -2*pi, 2*pi, 50, -pi, pi);
  TH2D *h_dPhi_diffD0_signal = new TH2D("h_dPhi_diffD0_signal", "h_dPhi_diffD0_signal", 50, -pi, pi, 50, -0.01, 0.01);
  TH2D *h_dPhi_diffD0_conver = new TH2D("h_dPhi_diffD0_conver", "h_dPhi_diffD0_conver", 50, -pi, pi, 50, -0.01, 0.01);
  TH2D *h_dPhi_diffD0_physic = new TH2D("h_dPhi_diffD0_physic", "h_dPhi_diffD0_physic", 50, -pi, pi, 50, -0.01, 0.01);
          ...
          if (MBCCut(MBC_physic))
          {
            ...
            if (DeltaMCut(DeltaM_physic))
            {
              ...
              if (dD0(d0_e_physic-d0_p_physic))
              {
                ...
                std::cout<<"Event passes dD0 with dPhi = "<<dPhi<<std::endl;
  ...
  std::cout<<"Number of signal events after pietaprimerho tag = "<<signalEvents.tagCut<<std::endl;
  ...
  std::cout<<"Number of conver events after pietaprimerho tag = "<<converEvents.tagCut<<std::endl;
  ...
  std::cout<<"Number of physic events after pietaprimerho tag = "<<physicEvents.tagCut<<std::endl;
  ...
  gPad->Print("dsPlusM_signal_pietaprimerho.png"); 
  dsPlusM->cd(2);
  h_dsPlusM_conver->Draw("SAME");
  ymax=(h_dsPlusM_conver->GetMaximum())*0.75;
  line = new TLine(xmin,ymax,xmin,0); line->Draw();
  line = new TLine(xmax,ymax,xmax,0); line->Draw();
  gPad->Print("dsPlusM_conver_pietaprimerho.png");
  dsPlusM->cd(3);
  h_dsPlusM_physic->Draw("SAME");
  ymax=(h_dsPlusM_physic->GetMaximum())*0.75;
  line = new TLine(xmin,ymax,xmin,0); line->Draw();
  line = new TLine(xmax,ymax,xmax,0); line->Draw();
  gPad->Print("dsPlusM_physic_pietaprimerho.png");
  ...
  line = new TLine(xmax, ymin, xmin, ymin); line->Draw();
  line = new TLine(xmin, ymin, xmin, ymax); line->Draw();
  gPad->Print("mBC_signal_pietaprimerho.png");
  MBC_DeltaM->cd(2);
  ...
  line = new TLine(xmax, ymin, xmin, ymin); line->Draw();
  line = new TLine(xmin, ymin, xmin, ymax); line->Draw();
  gPad->Print("mBC_conver_pietaprimerho.png");
  MBC_DeltaM->cd(3);
  ...
  line = new TLine(xmax, ymin, xmin, ymin); line->Draw();
  line = new TLine(xmin, ymin, xmin, ymax); line->Draw();
  gPad->Print("mBC_physic_pietaprimerho.png");
  ...
  line = new TLine(xmin,ymax,xmin,0); line->Draw();
  line = new TLine(xmax,ymax,xmax,0); line->Draw();
  gPad->Print("DeltaE_signal_pietaprimerho.png");
  DeltaE->cd(2);
  h_DeltaE_conver->Draw("SAME");
  ymax=(h_DeltaE_conver->GetMaximum())*0.75;
  line = new TLine(xmin,ymax,xmin,0); line->Draw();
  line = new TLine(xmax,ymax,xmax,0); line->Draw();
  gPad->Print("DeltaE_conver_pietaprimerho.png");
  DeltaE->cd(3);
  h_DeltaE_physic->Draw("SAME");
  ymax=(h_DeltaE_physic->GetMaximum())*0.75;
  line = new TLine(xmin,ymax,xmin,0); line->Draw();
  line = new TLine(xmax,ymax,xmax,0); line->Draw();
  gPad->Print("DeltaE_physic_pietaprimerho.png");
  ...
  line = new TLine(xmin,ymax,xmin,0); line->Draw();
  line = new TLine(xmax,ymax,xmax,0); line->Draw();
  gPad->Print("DeltaM_signal_pietaprimerho.png");
  DeltaM->cd(2);
  h_DeltaM_conver->Draw("SAME");
  ymax=(h_DeltaM_conver->GetMaximum())*0.75;
  line = new TLine(xmin,ymax,xmin,0); line->Draw();
  line = new TLine(xmax,ymax,xmax,0); line->Draw();
  gPad->Print("DeltaM_conver_pietaprimerho.png");
  DeltaM->cd(3);
  h_DeltaM_physic->Draw("SAME");
  ymax=(h_DeltaM_physic->GetMaximum())*0.75;
  line = new TLine(xmin,ymax,xmin,0); line->Draw();
  line = new TLine(xmax,ymax,xmax,0); line->Draw();
  gPad->Print("DeltaM_physic_pietaprimerho.png");
  ...
  gPad->Print("diffD0_signal_pietaprimerho.png");
  diffD0->cd(2);
  h_diffD0_conver->Draw("SAME");
  ymax=(h_diffD0_conver->GetMaximum())*0.75;
  line = new TLine(diffD0Cut,ymax,diffD0Cut,0); line->Draw();
  gPad->Print("diffD0_conver_pietaprimerho.png");
  diffD0->cd(3);
  h_diffD0_physic->Draw("SAME");
  ymax=(h_diffD0_physic->GetMaximum())*0.75;
  line = new TLine(diffD0Cut,ymax,diffD0Cut,0); line->Draw();
  gPad->Print("diffD0_physic_pietaprimerho.png");
  ...
  line = new TLine(xmax, ymin, xmin, ymin); line->Draw();
  line = new TLine(xmin, ymin, xmin, ymax); line->Draw();
  gPad->Print("dPhi_diffD0_signal_pietaprimerho.png");
  dPhi_diffD0->cd(2);
  ...
  line = new TLine(xmax, ymin, xmin, ymin); line->Draw();
  line = new TLine(xmin, ymin, xmin, ymax); line->Draw();
  gPad->Print("dPhi_diffD0_conver_pietaprimerho.png");
  dPhi_diffD0->cd(3);
  ...
  line = new TLine(xmax, ymin, xmin, ymin); line->Draw();
  line = new TLine(xmin, ymin, xmin, ymax); line->Draw();
  gPad->Print("dPhi_diffD0_physic_pietaprimerho.png");
  ...
  gPad->Print("dPhi_signal_pietaprimerho.png");
  dPhi->cd(2);
  h_dPhi_conver->Draw("SAME");
  ymax=(h_dPhi_conver->GetMaximum())*0.75;
  line = new TLine(dPhiCutLess,ymax,dPhiCutLess,0); line->Draw();
  gPad->Print("dPhi_conver_pietaprimerho.png");
  dPhi->cd(3);
  h_dPhi_physic->Draw("SAME");
  ymax=(h_dPhi_physic->GetMaximum())*0.75;
  line = new TLine(dPhiCutLess,ymax,dPhiCutLess,0); line->Draw();
  gPad->Print("dPhi_physic_pietaprimerho.png");
