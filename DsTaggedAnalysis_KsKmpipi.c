...
double dsPlusMCut_center=1.96849, dsPlusMCut_range=0.0123;
...
int DsTaggedAnalysis_KsKmpipi()
{

  TFile *signalFile = new TFile("MyDChainFile_MC_vtosll_KsKmpipi.root");
  ...
  TFile *converFile = new TFile("MyDChainFile_MCgamma_KsKmpipi.root");
  ...
  std::cout<<"Number of signal events after KsKmpipi tag = "<<signalEvents.tagCut<<std::endl;
  ...
  std::cout<<"Number of conver events after KsKmpipi tag = "<<converEvents.tagCut<<std::endl;
  ...
  std::cout<<"Number of physic events after KsKmpipi tag = "<<physicEvents.tagCut<<std::endl;
  ...
  line = new TLine(xmax, ymin, xmin, ymin); line->Draw();
  line = new TLine(xmin, ymin, xmin, ymax); line->Draw();
  gPad->Print("mBC_signal_KsKmpipi.png");
  MBC_DeltaM->cd(2);
  ...
  line = new TLine(xmax, ymin, xmin, ymin); line->Draw();
  line = new TLine(xmin, ymin, xmin, ymax); line->Draw();
  gPad->Print("mBC_conver_KsKmpipi.png");
  MBC_DeltaM->cd(3);
  ...
  line = new TLine(xmax, ymin, xmin, ymin); line->Draw();
  line = new TLine(xmin, ymin, xmin, ymax); line->Draw();
  gPad->Print("mBC_physic_KsKmpipi.png");
  ...
  line = new TLine(xmax, ymin, xmin, ymin); line->Draw();
  line = new TLine(xmin, ymin, xmin, ymax); line->Draw();
  gPad->Print("dPhi_diffD0_signal_KsKmpipi.png");
  dPhi_diffD0->cd(2);
  ...
  line = new TLine(xmax, ymin, xmin, ymin); line->Draw();
  line = new TLine(xmin, ymin, xmin, ymax); line->Draw();
  gPad->Print("dPhi_diffD0_conver_KsKmpipi.png");
  dPhi_diffD0->cd(3);
  ...
  line = new TLine(xmax, ymin, xmin, ymin); line->Draw();
  line = new TLine(xmin, ymin, xmin, ymax); line->Draw();
  gPad->Print("dPhi_diffD0_physic_KsKmpipi.png");
