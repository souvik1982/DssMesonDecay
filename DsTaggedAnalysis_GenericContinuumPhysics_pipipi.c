...
int DsTaggedAnalysis_GenericContinuumPhysics_pipipi()
{
  ...
  std::cout<<"Number of generic events after pipipi tag = "<<genericEvents.tagCut<<std::endl;
  ...
  std::cout<<"Number of continu events after pipipi tag = "<<continuEvents.tagCut<<std::endl;
  ...
  std::cout<<"Number of physics events after pipipi tag = "<<physicsEvents.tagCut<<std::endl;
  ...
  line = new TLine(xmax, ymin, xmin, ymin); line->Draw();
  line = new TLine(xmin, ymin, xmin, ymax); line->Draw();
  gPad->Print("mBC_DeltaM_generic_pipipi.png");
  MBC_DeltaM->cd(2);
  ...
  line = new TLine(xmax, ymin, xmin, ymin); line->Draw();
  line = new TLine(xmin, ymin, xmin, ymax); line->Draw();
  gPad->Print("mBC_DeltaM_continu_pipipi.png");
  MBC_DeltaM->cd(3);
  ...
  line = new TLine(xmax, ymin, xmin, ymin); line->Draw();
  line = new TLine(xmin, ymin, xmin, ymax); line->Draw();
  gPad->Print("mBC_DeltaM_physics_pipipi.png");
  ...
  */
  ...
  line = new TLine(xmin,ymax,xmin,0); line->Draw();
  line = new TLine(xmax,ymax,xmax,0); line->Draw();
  gPad->Print("mBC_generic_pipipi.png");
  MBC->cd(2);
  h_MBC_continu->Draw();
  ymax=(h_MBC_continu->GetMaximum())*0.75;
  line = new TLine(xmin,ymax,xmin,0); line->Draw();
  line = new TLine(xmax,ymax,xmax,0); line->Draw();
  gPad->Print("mBC_continu_pipipi.png");
  MBC->cd(3);
  h_MBC_physics->Draw();
  ymax=(h_MBC_physics->GetMaximum())*0.75;
  line = new TLine(xmin,ymax,xmin,0); line->Draw();
  line = new TLine(xmax,ymax,xmax,0); line->Draw();
  gPad->Print("mBC_physics_pipipi.png");
  ...
  gPad->Print("dPhi_generic_pipipi.png");
  dPhi->cd(2);  
  h_dPhi_continu->Draw();
  ymax=(h_dPhi_continu->GetMaximum())*0.75;
  line = new TLine(dPhiCutLess,ymax,dPhiCutLess,0); line->Draw();
  gPad->Print("dPhi_continu_pipipi.png");
  dPhi->cd(3);
  h_dPhi_physics->Draw();
  ymax=(h_dPhi_physics->GetMaximum())*0.75;
  line = new TLine(dPhiCutLess,ymax,dPhiCutLess,0); line->Draw();
  gPad->Print("dPhi_physics_pipipi.png");
