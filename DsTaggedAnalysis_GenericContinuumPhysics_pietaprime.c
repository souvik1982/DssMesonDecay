...
int DsTaggedAnalysis_GenericContinuumPhysics_pietaprime()
{
  ...
  std::cout<<"Number of generic events after pietaprime tag = "<<genericEvents.tagCut<<std::endl;
  ...
  std::cout<<"Number of continu events after pietaprime tag = "<<continuEvents.tagCut<<std::endl;
  ...
  std::cout<<"Number of physics events after pietaprime tag = "<<physicsEvents.tagCut<<std::endl;
  ...
  gPad->Print("dsPlusM_generic_pietaprime.png"); 
  dsPlusM->cd(2);
  h_dsPlusM_continu->Draw();
  ymax=(h_dsPlusM_continu->GetMaximum())*0.75;
  line = new TLine(xmin,ymax,xmin,0); line->Draw();
  line = new TLine(xmax,ymax,xmax,0); line->Draw();
  gPad->Print("dsPlusM_continu_pietaprime.png");
  dsPlusM->cd(3);
  h_dsPlusM_physics->Draw();
  ymax=(h_dsPlusM_physics->GetMaximum())*0.75;
  line = new TLine(xmin,ymax,xmin,0); line->Draw();
  line = new TLine(xmax,ymax,xmax,0); line->Draw();
  gPad->Print("dsPlusM_physics_pietaprime.png");
  ...
  line = new TLine(xmin,ymax,xmin,0); line->Draw();
  line = new TLine(xmax,ymax,xmax,0); line->Draw();
  gPad->Print("DeltaE_generic_pietaprime.png");
  DeltaE->cd(2);
  h_DeltaE_continu->Draw();
  ymax=(h_DeltaE_continu->GetMaximum())*0.75;
  line = new TLine(xmin,ymax,xmin,0); line->Draw();
  line = new TLine(xmax,ymax,xmax,0); line->Draw();
  gPad->Print("DeltaE_continu_pietaprime.png");
  DeltaE->cd(3);
  h_DeltaE_physics->Draw();
  ymax=(h_DeltaE_physics->GetMaximum())*0.75;
  line = new TLine(xmin,ymax,xmin,0); line->Draw();
  line = new TLine(xmax,ymax,xmax,0); line->Draw();
  gPad->Print("DeltaE_physics_pietaprime.png");
  ...
  line = new TLine(xmin,ymax,xmin,0); line->Draw();
  line = new TLine(xmax,ymax,xmax,0); line->Draw();
  gPad->Print("mBC_generic_pietaprime.png");
  MBC->cd(2);
  h_MBC_continu->Draw();
  ymax=(h_MBC_continu->GetMaximum())*0.75;
  line = new TLine(xmin,ymax,xmin,0); line->Draw();
  line = new TLine(xmax,ymax,xmax,0); line->Draw();
  gPad->Print("mBC_continu_pietaprime.png");
  MBC->cd(3);
  h_MBC_physics->Draw();
  ymax=(h_MBC_physics->GetMaximum())*0.75;
  line = new TLine(xmin,ymax,xmin,0); line->Draw();
  line = new TLine(xmax,ymax,xmax,0); line->Draw();
  gPad->Print("mBC_physics_pietaprime.png");
  ...
  line = new TLine(xmin,ymax,xmin,0); line->Draw();
  line = new TLine(xmax,ymax,xmax,0); line->Draw();
  gPad->Print("DeltaM_generic_pietaprime.png");
  DeltaM->cd(2);
  h_DeltaM_continu->Draw();
  ymax=(h_DeltaM_continu->GetMaximum())*0.75;
  line = new TLine(xmin,ymax,xmin,0); line->Draw();
  line = new TLine(xmax,ymax,xmax,0); line->Draw();
  gPad->Print("DeltaM_continu_pietaprime.png");
  DeltaM->cd(3);
  h_DeltaM_physics->Draw();
  ymax=(h_DeltaM_physics->GetMaximum())*0.75;
  line = new TLine(xmin,ymax,xmin,0); line->Draw();
  line = new TLine(xmax,ymax,xmax,0); line->Draw();
  gPad->Print("DeltaM_physics_pietaprime.png");
  ...
  gPad->Print("dPhi_generic_pietaprime.png");
  dPhi->cd(2);  
  h_dPhi_continu->Draw();
  ymax=(h_dPhi_continu->GetMaximum())*0.75;
  line = new TLine(dPhiCutLess,ymax,dPhiCutLess,0); line->Draw();
  gPad->Print("dPhi_continu_pietaprime.png");
  dPhi->cd(3);
  h_dPhi_physics->Draw();
  ymax=(h_dPhi_physics->GetMaximum())*0.75;
  line = new TLine(dPhiCutLess,ymax,dPhiCutLess,0); line->Draw();
  gPad->Print("dPhi_physics_pietaprime.png");
