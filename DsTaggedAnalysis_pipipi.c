...
int DsTaggedAnalysis_pipipi()
{

  TFile *signalFile = new TFile("MyDChainFile_MC_vtosll_pipipi.root");
  signalFile->cd("DsTaggedDecaysProc");
  TTree *signalTree = (TTree*)gDirectory->Get("nt5");
  
  TFile *converFile = new TFile("MyDChainFile_MCgamma_pipipi.root");
  ...
  std::cout<<"Number of signal events after pipipi tag = "<<signalEvents.tagCut<<std::endl;
  ...
  std::cout<<"Number of conver events after pipipi tag = "<<converEvents.tagCut<<std::endl;
  ...
  {
    std::cout<<"Data decay mode "<<i_decay->first<<" had "<<i_decay->second<<" decays"<<std::endl;
  }
  std::cout<<"Number of physic events after ntuplizer = "<<physicEvents.noCut<<std::endl;
  std::cout<<"Number of physic events after pipipi tag = "<<physicEvents.tagCut<<std::endl;
  ...
  line = new TLine(xmax, ymin, xmin, ymin); line->Draw();
  line = new TLine(xmin, ymin, xmin, ymax); line->Draw();
  gPad->Print("mBC_signal_pipipi.png");
  MBC_DeltaM->cd(2);
  ...
  line = new TLine(xmax, ymin, xmin, ymin); line->Draw();
  line = new TLine(xmin, ymin, xmin, ymax); line->Draw();
  gPad->Print("mBC_conver_pipipi.png");
  MBC_DeltaM->cd(3);
  ...
  line = new TLine(xmax, ymin, xmin, ymin); line->Draw();
  line = new TLine(xmin, ymin, xmin, ymax); line->Draw();
  gPad->Print("mBC_physic_pipipi.png");
  ...
  line = new TLine(xmax, ymin, xmin, ymin); line->Draw();
  line = new TLine(xmin, ymin, xmin, ymax); line->Draw();
  gPad->Print("dPhi_diffD0_signal_pipipi.png");
  dPhi_diffD0->cd(2);
  ...
  line = new TLine(xmax, ymin, xmin, ymin); line->Draw();
  line = new TLine(xmin, ymin, xmin, ymax); line->Draw();
  gPad->Print("dPhi_diffD0_conver_pipipi.png");
  dPhi_diffD0->cd(3);
  ...
  line = new TLine(xmax, ymin, xmin, ymin); line->Draw();
  line = new TLine(xmin, ymin, xmin, ymax); line->Draw();
  gPad->Print("dPhi_diffD0_physic_pipipi.png");
